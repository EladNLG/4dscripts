    ...
    case "mp_rr_canyonlands_64k_x_64k":
        Shared_RegisterLocation(
            NewLocationSettings(
                "4D4Room",
                [
                    NewLocPair(<-5888.29,-35847.7,4351.1>, <0,180,0>),
                    NewLocPair( <-6144.54,-36095.5,4351.3>, <0,-90,0>),
                    NewLocPair( <-5888.27,-36095.6,4351.13>, <0,180,0>),
                    NewLocPair( <-6144.07,-35839.2,4351.45>, <0,180,0>),
                    NewLocPair( <-3712.55,-37888.1,4287.17>, <0,-90,0>),
                    NewLocPair( <-4031.53,-35136.4,4351.2>, <0,90,0>),
                    NewLocPair( <-4031.75,-33983.2,4351.41>, <0,180,0>),
                    NewLocPair( <-5184.44,-33983.6,4351.22>, <0,-90,0>),
                    NewLocPair( <-6655.8,-36608.6,4095.24>, <0,0,0>),
